export default function getAdverts(i18n) {
	return [
		{
			href: 'https://www.patreon.com/opendyslexic',
			text: i18n('followAbbie')
		},
		{
			href: 'https://github.com/OpenDyslexic/extension',
			text: i18n('weAreOnGithub')
		},
		{
