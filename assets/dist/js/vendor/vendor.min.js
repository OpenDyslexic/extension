...
/* globals jQuery */
!function(t){function i(t){return"undefined"==typeof t.which||"number"==typeof t.which&&t.which>0&&(!t.ctrlKey&&!t.metaKey&&!t.altKey&&8!=t.which&&9!=t.which)}
// Selector to select only not already processed elements
t.expr[":"].notmdproc=function(i){return!t(i).data("mdproc")},t.material={options:{
// These options set what will be started by $.material.init()
input:!0,ripples:!0,checkbox:!0,togglebutton:!0,radio:!0,arrive:!0,autofill:!1,withRipples:[".btn:not(.btn-link)",".card-image",".navbar a:not(.withoutripple)",".dropdown-menu a",".nav-tabs a:not(.withoutripple)",".withripple"].join(","),inputElements:"input.form-control, textarea.form-control, select.form-control",checkboxElements:".checkbox > label > input[type=checkbox]",togglebuttonElements:".togglebutton > label > input[type=checkbox]",radioElements:".radio > label > input[type=radio]"},checkbox:function(i){
// Add fake-checkbox to material checkboxes
t(i?i:this.options.checkboxElements).filter(":notmdproc").data("mdproc",!0).after("<span class=checkbox-material><span class=check></span></span>")},togglebutton:function(i){
// Add fake-checkbox to material checkboxes
t(i?i:this.options.togglebuttonElements).filter(":notmdproc").data("mdproc",!0).after("<span class=toggle></span>")},radio:function(i){
// Add fake-radio to material radios
t(i?i:this.options.radioElements).filter(":notmdproc").data("mdproc",!0).after("<span class=circle></span><span class=check></span>")},input:function(n){t(n?n:this.options.inputElements).filter(":notmdproc").data("mdproc",!0).each(function(){var i=t(this);if(t(this).attr("data-hint")||i.hasClass("floating-label")){
// Add floating label if required
if(i.wrap("<div class=form-control-wrapper></div>"),i.after("<span class=material-input></span>"),i.hasClass("floating-label")){var n=i.attr("placeholder");i.attr("placeholder",null).removeClass("floating-label"),i.after("<div class=floating-label>"+n+"</div>")}
// Support for file input
if(
// Add hint label if required
i.attr("data-hint")&&i.after("<div class=hint>"+i.attr("data-hint")+"</div>"),
// Set as empty if is empty (damn I must improve this...)
null!==i.val()&&"undefined"!=i.val()&&""!==i.val()||i.addClass("empty"),i.parent().next().is("[type=file]")){i.parent().addClass("fileinput");var e=i.parent().next().detach();i.after(e)}}}),t(document).on("change",".checkbox input[type=checkbox]",function(){t(this).blur()}).on("keydown paste",".form-control",function(n){i(n)&&t(this).removeClass("empty")}).on("keyup change",".form-control",function(){var i=t(this);""===i.val()&&"undefined"!=typeof i[0].checkValidity&&i[0].checkValidity()?i.addClass("empty"):i.removeClass("empty")}).on("focus",".form-control-wrapper.fileinput",function(){t(this).find("input").addClass("focus")}).on("blur",".form-control-wrapper.fileinput",function(){t(this).find("input").removeClass("focus")}).on("change",".form-control-wrapper.fileinput [type=file]",function(){var i="";t.each(t(this)[0].files,function(t,n){i+=n.name+", "}),i=i.substring(0,i.length-2),i?t(this).prev().removeClass("empty"):t(this).prev().addClass("empty"),t(this).prev().val(i)})},ripples:function(i){t(i?i:this.options.withRipples).ripples()},autofill:function(){
// This part of code will detect autofill when the page is loading (username and password inputs for example)
var i=setInterval(function(){t("input[type!=checkbox]").each(function(){t(this).val()&&t(this).val()!==t(this).attr("value")&&t(this).trigger("change")})},100);
