...
n.prototype.getRelX=function(t,e){var o=t.offset();/**
       ...
       */
return a.isTouch()?(e=e.originalEvent,1!==e.touches.length?e.touches[0].pageX-o.left:!1):e.pageX-o.left},/**
   * Get the relY
   */
n.prototype.getRelY=function(t,e){var o=t.offset();/**
       ...
       * position relative to the ripple wrapper
       */
return a.isTouch()?(e=e.originalEvent,1!==e.touches.length?e.touches[0].pageY-o.top:!1):e.pageY-o.top},/**
   * Get the ripple color
   */
